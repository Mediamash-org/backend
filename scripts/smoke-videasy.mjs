import { createOmssProviders } from '@omss-server/videasy-provider'

const [provider] = createOmssProviders({ maxStreams: 4, servers: ['cdn', 'm4uhd'] })
