...
The LG webOS app (`apps/webos`) is built separately and pointed at your `PUBLIC_URL`. It is not baked into this image.
...
2. Build the TV app: `npm run webos:build` (see [`apps/webos/README.md`](../apps/webos/README.md)).
